...
def execute(filters=None):
    ...
    columns = [
        {"fieldname": "room", "editable" : True , "label": "Room", "fieldtype": "Link", "options": "Room"},
    ...
    room_assigned = filters.get('room_assigned')
    ...
    # Conditional logic for room_assigned filter
    if room_assigned == "Yes":
        room_assigned_condition = "AND r.room IS NOT NULL"
    elif room_assigned == "No":
        room_assigned_condition = "AND r.room IS NULL"
    else:
