CREATE TABLE IF NOT EXISTS date_snapshot (
    snapshot_date INT(8) UNSIGNED NOT NULL PRIMARY KEY,
    total_rooms INT,
    total_occ INT,
    ooo_rooms INT,
    oos_rooms INT,
    ...
    departure_rooms INT,
    arrival_adults INT,
    arrival_children INT,
    arrival_infants INT,
    departure_adults INT,
    departure_children INT,
    departure_infants INT,
    in_house_adults INT,
    in_house_children INT,
    in_house_infants INT,
    adr DECIMAL(10, 2),
    total_gross_revenue DECIMAL(12, 2),
    taxes DECIMAL(12, 2),
    arrivals_revenue DECIMAL(12, 2),
    arrivals_taxes DECIMAL(12, 2),
    departures_revenue DECIMAL(12, 2),
    departures_taxes DECIMAL(12, 2),
    new_reservations_revenue DECIMAL(12, 2),
    new_reservations_gross DECIMAL(12, 2),
    cancel_count INT,
    cancel_revenue DECIMAL(12, 2),
    cancel_ta_count INT,
    travel_agent_adults INT,
    travel_agent_children INT,
    travel_agent_infants INT,
    travel_agent_revenue DECIMAL(12, 2),
    travel_agent_taxes DECIMAL(12, 2),
    company_count INT,
    company_adults INT,
    company_children INT,
    company_infants INT,
    company_revenue DECIMAL(12, 2),
    company_taxes DECIMAL(12, 2),
    complementary_count INT,
    complementary_revenue DECIMAL(12, 2),
    house_use_count INT,
    house_use_revenue DECIMAL(12, 2)
