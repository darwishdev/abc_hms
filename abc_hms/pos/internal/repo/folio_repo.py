...
class FolioRepo:
    def folio_window_list(self, folio:str):
        return frappe.get_all("Folio Window" , {
            "Folio" : folio,
        } , [
                              "name",
                              "window_label"
    ...
    def folio_item_transfer(self, source_folio , destination_folio , destination_window , source_window,item_names ):
        folio = frappe.get_doc('Folio' , source_folio)
        return folio.folio_item_transfer(destination_folio, destination_window , source_window , item_names)
