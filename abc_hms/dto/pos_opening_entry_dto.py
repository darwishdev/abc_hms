...
POSClosingEntryFromOpeningResponse = Union[
    POSClosingEntryFromOpeningResult, ErrorResponse
]
...
POSOpeningEntryFindByProfileResponse = Union[
    POSOpeningEntryFindByProfileResult, ErrorResponse
]
