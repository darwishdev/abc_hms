...
from abc_hms.pos.internal.usecase.folio_usecase import FolioUsecase
from abc_hms.pos.internal.usecase.auth_usecase import AuthUsecase
from abc_hms.pos.internal.usecase.pos_closing_entry_usecase import POSClosingEntryUsecase
from abc_hms.pos.internal.usecase.pos_invoice_usecase import POSInvoiceUsecase
from abc_hms.pos.internal.usecase.pos_opening_entry_usecase import POSOpeningEntryUsecase
from abc_hms.pos.internal.usecase.pos_session_usecase import POSSessionUsecase
from abc_hms.pos.internal.usecase.restaurant_table_usecase import RestaurantTableUsecase
from abc_hms.pos.internal.usecase.pos_profile_usecase import POSProfileUsecase
from abc_hms.property.internal.usecase.property_setting_usecase import PropertySettingUsecase
from abc_hms.property.internal.usecase.rate_code_usecase import RateCodeUsecase
...
class AppContainer:
    def __init__(self):
        ...
        self.rate_code_usecase = RateCodeUsecase()
